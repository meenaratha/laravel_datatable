          ...
          <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">User Personal Details</h6>
                            <form class="forms-sample" action="/add-user" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="exampleInputName1" name="email" placeholder="Last Name">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control " id="exampleInputName1" name="confirm_password">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputName1">NRIC Number</label>
                                    <input type="text" class="form-control" id="exampleInputName1" name="NRICnumber" placeholder="NRIC Number">
                                </div>
                                <div class="form-group">
